export const ORG = "A.M. Reddy Memorial College of Pharmacy";
...
export function buildIcs(personalizedFor?: string) {
  ...
  const description = personalizedFor
    ? `Dear ${personalizedFor}, you are cordially invited to the ${EVENT_TITLE} at ${ORG}.`
    : `You are cordially invited to the ${EVENT_TITLE} at ${ORG}.`;
